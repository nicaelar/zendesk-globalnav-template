...
`,oe=()=>e.jsxs(Re,{children:[e.jsx(h.XL,{tag:"h1",style:{marginBottom:"16px"},children:"Support's main content area"}),e.jsx("p",{children:"This is where your Support page content will be displayed."})]}),qe=o.div`
  ...
  padding: 24px;
  overflow: auto;
`,se=()=>e.jsxs(qe,{children:[e.jsx(h.XL,{tag:"h1",style:{marginBottom:"16px"},children:"Knowledge's main content area"}),e.jsx("p",{children:"This is where your Knowledge page content will be displayed."})]}),Ve=o.div`
  flex: 1;
  width: 100%;
  padding: 24px;
  overflow: auto;
`,te=()=>e.jsxs(Ve,{children:[e.jsx(h.XL,{tag:"h1",style:{marginBottom:"16px"},children:"AI agents's main content area"}),e.jsx("p",{children:"This is where your AI agents page content will be displayed."})]}),He=o.div`
  flex: 1;
  width: 100%;
  padding: 24px;
  overflow: auto;
